...
class starter {
	public static void main(String args[]) {
		...
		int num = 1;
		while (num < 36){
			System.out.println(Cipher.keyedEncode("u4y i1e i5 i6ita5c 314c1i66e1 i5f by6i5 hea5c zbi58 u4y", num));
			num = num + 1;
		}
		System.out.println();
		int numAgain = 1;
		while (numAgain < 36){
			System.out.println(Cipher.keyedEncode("amlb mfhp7fcj jlgq fo tap s9a bjlslql aflipa lb hlg9b 210z t9ct", numAgain));
			numAgain = numAgain + 1;
		}
	}
}
