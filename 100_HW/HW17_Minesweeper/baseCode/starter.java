    ...
    */
    public static void reveal(int r, int c, int [][] guessGrid, int[][] bombProxGrid){
        ...
        for (int i = 0; i < answerGrid.length; i++){
            for (int l = 0; l < answerGrid[0].length; l++){
                answerGrid[i][l] = bombProxGrid[r+1][c+1];
                answerGrid[i][l] = bombProxGrid[r-1][c-1];
                answerGrid[i][l] = bombProxGrid[r+1][c];
                answerGrid[i][l] = bombProxGrid[r-1][c];
                answerGrid[i][l] = bombProxGrid[r][c+1];
                answerGrid[i][l] = bombProxGrid[r][c-1];
            }
        }
