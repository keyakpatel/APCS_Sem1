	...
	public static void main(String args[]) throws InterruptedException {
		...
		while (true){
			...
			if (choice == 2){
				...
				int playFor2 = sc.nextInt();
				System.out.println("--------------Your sentence is--------------");
				given = getSentence(playFor2);
				System.out.println(given);
				System.out.println("--------------------------------------------");
					countdown();
				startTimer();
			...
			if (choice == 3){
				System.out.println("Great game! Hope to see you again soon!");
				break;
			}
			
			System.out.println("Nice Job! Here is your result!");
			System.out.println(("Time: ") + endTimer());
			System.out.println(("Errors: ") + compareSentences(typed, given));
			System.out.print(lettersInSentence(typed));
			System.out.println(" letters per minute");
			System.out.print(wordsInSentence(typed));
